...
- (void)viewDidLoad {
    ...
    //    [[UINavigationBar appearance]setBackgroundImage:[UIImage imageNamed:@"segment-indicator"] forBarMetrics:UIBarMetricsDefault];
    //    [UINavigationBar appearance].translucent = NO;  ///////   IOS7 会crash
    self.navigationBar.translucent = NO;
    [self.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor redColor],NSForegroundColorAttributeName,nil]];
